...
plugin(
    name = "demeter-coroutine-tracer",
    pluginId = "com.yandex.demeter.coroutine.tracer",
    implementation = "com.yandex.demeter.coroutine.tracer.plugin.DemeterCoroutineTracerPlugin",
)
...
mavenPublishing {
    ...
    pom { configurePom("Demeter Coroutine Tracer Gradle Plugin") }
}
